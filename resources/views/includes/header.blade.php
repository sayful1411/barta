                ...
                <div class="hidden sm:ml-6 sm:flex gap-2 sm:items-center">
                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute right-3 mt-3 z-10 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button"
                            tabindex="-1">
                            <div>
                                <div class="px-2 py-2 my-1 bg-slate-400">
                                    <p><b>Md</b> likes your post</p>
                                </div>
                                <div class="px-2 py-2 my-1 bg-slate-400">
                                    <p><b>Md</b> commented your post</p>
                                </div>
                            </div>

                            <a href="#">
                                <button type="button"
                                    class="mt-5 w-full text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded text-sm px-5 py-2.5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <a href="{{ route('password.edit') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem"
                                tabindex="-1" id="user-menu-item-1">Setting</a>
            ...
            <div class="border-t border-gray-200 pt-4 pb-3">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <a href="{{ route('profile.edit') }}"
                        ...
                        Profile</a>
                    <a href="{{ route('password.edit') }}"
                        class="block px-4 py-2 text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800">Setting</a>
                    {{-- <a href="{{ route('logout') }}"
